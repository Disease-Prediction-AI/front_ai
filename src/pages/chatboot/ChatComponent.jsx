...
const ChatComponent = () => {
  ...
  return (
    <div className="items-center justify-center text-white">
      <div className=" min-w-full h-[93vh] max-w-md rounded-lg flex flex-col justify-between shadow-md p-4">
        <div className="flex items-center mb-4">
          <div className="ml-3">
            <p className="text-xl font-medium">Medical Assistant</p>
        ...
        <div className="mt-4 flex items-center ">
          ...
          <button
            ...
            } text-white px-4 py-2 rounded-full ml-3 hover:bg-blue-600`}
          >
            Send
          </button>
        </div>
